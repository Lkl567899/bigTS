...
import avatar from '@/assets/maomao.webp'
...
<template>
  <el-container class="layout-container">
    ...
    <el-container>
      <el-header>
        <div>用户名：<strong>{{ userStore.userInfo.nickname || userStore.userInfo.username }}</strong></div>
...
.layout-container {
  ...
  .el-aside {
    ...
    &__logo {
      height: 120px;
      background: url('@/assets/maomao.webp') no-repeat center / 120px auto;
    }
